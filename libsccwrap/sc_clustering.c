...
#define __PYX_HAVE__sc_clustering
#define __PYX_HAVE_API__sc_clustering
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
#include "stdint.h"
#include "libscclust/include/scclust.h"
#include "libscclust/include/error.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
 ...
 *
 */
typedef __pyx_t_5numpy_float_t __pyx_t_13sc_clustering_DTYPE_t;
/* None.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'sc_clustering' */
#define __Pyx_MODULE_NAME "sc_clustering"
int __pyx_module_is_main_sc_clustering = 0;

/* Implementation of 'sc_clustering' */
...
static PyObject *__pyx_f_13sc_clustering_sccw_sc_clustering(CYTHON_UNUSED PyObject *const __pyx_v_self, CYTHON_UNUSED PyObject *const __pyx_v_args) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("sccw_sc_clustering", 0);

  /* "sc_clustering.pyx":58
 *
 * cdef sccw_sc_clustering(PyObject* const self, PyObject* const args):
 *     return None             # <<<<<<<<<<<<<<
 */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsc_clustering(void); /*proto*/
PyMODINIT_FUNC initsc_clustering(void)
#else
PyMODINIT_FUNC PyInit_sc_clustering(void); /*proto*/
PyMODINIT_FUNC PyInit_sc_clustering(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_sc_clustering(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("sc_clustering", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sc_clustering) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sc_clustering")) {
      if (unlikely(PyDict_SetItemString(modules, "sc_clustering", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE, __pyx_t_2) < 0) __PYX_ERR(1, 12, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sc_clustering", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sc_clustering");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
